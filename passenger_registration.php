...
<html lang="en">
  ...
  aria-hidden="true" data-backdrop="static" data-keyboard="false">
	...
	<!-- Passenger Registration form starts -->
	<div id="hero-area" class="hero-area-bg">
        <div class="container">
		<div class="passenger_reg" data-keyboard="false">
		  <div class="modal-dialog signupForm" role="document">
			...
			<div class="modal-content">
			  <div class="modal-header text-center">
				<h4 class="modal-title w-100 font-weight-bold">Passenger Sign Up</h4>
			  ...
			  <div class="section_a">
				...
				<div class="md-form mb-5">
				  <i class="lni-user"></i>
				  <input name="name" placeholder="Enter Name" value="<?php if(isset($_POST['passengerSignup'])){ echo $name;}?>" type="text" id="orangeForm-name" class="form-control validate" onkeydown="getSignUpValue(event)">
				  <label data-error="wrong" data-success="right" for="orangeForm-name">Name</label>
				  <span class="require">*</span>
				  <span class="error_msg" id="name_err"><?php if(isset($_POST['passengerSignup'])){echo $nameErr;}?></span>
				</div>
				<!-- email field -->
				<div class="md-form mb-5">
				  <i class="lni-envelope"></i>
				  <input name="email" placeholder="Enter Email" value="<?php if(isset($_POST['passengerSignup'])){ echo $email;}?>" type="text" id="orangeForm-email" class="form-control" onkeydown="getSignUpValue(event)">
				  <label data-error="wrong" data-success="right" for="orangeForm-email">Email</label>
				  <span class="require">*</span>
				  <span class="error_msg" id="email_signerror"><?php if(isset($_POST['passengerSignup'])){echo $emailErr;}?></span>
				</div>
				<!-- password field -->
				<div class="md-form mb-4">
				  <i class="lni-lock"></i>
				  ...
				  <span class="require">*</span>
				  <span class="error_msg" id="sigpaswd_err"><?php if(isset($_POST['passengerSignup'])){echo $passwordErr;}?></span>
				</div>
				...
				<div class="md-form mb-4">
				  ...
				  <input type="text" value="<?php if(isset($_POST['passengerSignup'])){ echo $dateOfBirth;}?>" readonly id="date" name="date" placeholder="YYYY/MM/DD" data-provide="datepicker" class="form-control validate">
				  <label data-error="wrong" data-success="right" for="orangeForm-dob">Birth Date</label>
				</div>
				<!-- gender field -->
				<div class="md-form mb-4">
				  <div class="gender_radio">
					<input class="form-check-input" type="radio" checked="checked" name="inlineRadioOptions" id="radio1" value="M" <?php if (isset($_POST["passengerSignup"]) && ($_POST["inlineRadioOptions"] == 'M')) {echo 'checked="checked"';}?>>
					<label>Male</label>
				  </div>
                  <div class="gender_radio">				  
					<input class="form-check-input" type="radio" name="inlineRadioOptions" id="radio2" value="F" <?php if (isset($_POST["passengerSignup"]) && ($_POST["inlineRadioOptions"] == 'F')) {echo 'checked="checked"';}?>>
					<label>Female</label>
				   </div>
				   <div class="gender_radio">
					<input class="form-check-input" type="radio" name="inlineRadioOptions" id="radio3" value="O" <?php if (isset($_POST["passengerSignup"]) && ($_POST["inlineRadioOptions"] == 'O')) {echo 'checked="checked"';}?>>
					<label>Other</label>
				  </div>
				  <label class="for_genders" data-error="wrong" data-success="right" for="orangeForm-gender">Gender</label>
				  <span class="require">*</span>
				  <span class="error_msg" id="siggendr_err"><?php if(isset($_POST['passengerSignup'])){echo $genderErr;}?></span>
				</div>
				<!-- contact field -->
				<div class="md-form mb-4">
				  <i class="lni-phone"></i>
				  <input type="text" placeholder="Enter Contact Number" value="<?php if(isset($_POST['passengerSignup'])){ echo $contact;}?>" name="contact" id="orangeForm-contact" class="form-control validate" maxlength="10" onkeydown="getSignUpValue(event)">
				  <label data-error="wrong" data-success="right" for="orangeForm-pass">Contact Number</label>
				  <span class="require">*</span>
				  <span class="error_msg" id="sigcontac_err"><?php if(isset($_POST['passengerSignup'])){echo $contactErr;}?></span>
				</div>
				</div>
				...
				<div class="section_c">
				  ...
				  <i class="lni lni-home"></i>
					<textarea id="address" placeholder="Enter Address" name="addres" rows="1" cols="109"><?php if(isset($_POST['passengerSignup'])){ echo $addres;}?> </textarea>
					<label data-error="wrong" data-success="right" for="orangeForm-adres">Address</label>
					<span class="require">*</span>
				    <span class="error_msg" id="sigadres_err"><?php if(isset($_POST['passengerSignup'])){echo $adresErr;}?></span>
				  </div>
				</div>
			  ...
			  <div class="modal-footer d-flex justify-content-center">
				...
				<input type="hidden" name="passengerSignup">
			  </div>
			</div>
			</form>
		  </div>
