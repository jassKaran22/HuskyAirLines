				...
				<table id="pilots_report" class="display" style="width:100%">
					...
					<tbody>
						...
						foreach($res as $key => $record){
							...
							<td>'.$record['passenger_dob'].'</td>
							<td>'.$record['passenger_gender'].'</td>
							<td>'.$record['passenger_contact'].'</td>
							<td>'.$record['passenger_address'].'</td>
							</tr>';
						}?>						
					</tbody>
				</table>
