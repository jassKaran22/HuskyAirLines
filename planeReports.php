				...
				<table id="pilots_report" class="display" style="width:100%">
					<thead>
						<tr>
							<th>Plane Name</th>
							<th>Pilot Name</th>
							<th>Plane Engine Number</th>
							<th>Fuel Capacity</th>
							<th>Guest Capacity</th>
							<th>Plane Lavatories</th>
							<th>Cruise Speed</th>
						</tr>
					</thead>
					<tbody>
						...
						foreach($res as $key => $record){
							echo '<tr>
							<td>'.$record['plane_name'].'</td>
							<td>'.$record['Name'].'</td>
							<td>'.$record['plane_engNum'].'</td>
							<td>'.$record['plane_fuelcapacity'].'</td>
							<td>'.$record['plane_guestcapacity'].'</td>
							<td>'.$record['plane_lavatories'].'</td>
							<td>'.$record['plane_cruisespeed'].'</td>
							</tr>';
						}?>						
					</tbody>
				</table>
