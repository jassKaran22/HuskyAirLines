...
<html lang="en">
  ...
  aria-hidden="true" data-backdrop="static" data-keyboard="false">
	...
	<div id="hero-area" class="hero-area-bg">
        <div class="container">
		<div class="doc_reg" data-keyboard="false">
		  <div class="modal-dialog signupForm" role="document">
			...
			<div class="modal-content">
			  <div class="modal-header text-center">
				<h4 class="modal-title w-100 font-weight-bold">Doctor Sign Up</h4>
			  ...
			  <div class="section_a">
				...
				<div class="md-form mb-5">
				  <i class="lni-user"></i>
				  <input name="name" placeholder="Enter Name" value="<?php if(isset($_POST['signup'])){ echo $name;}?>" type="text" id="orangeForm-name" class="form-control validate" onkeydown="getSignUpValue(event)">
				  <label data-error="wrong" data-success="right" for="orangeForm-name">Name</label>
				  <span class="require">*</span>
				  <span class="error_msg" id="name_err"><?php if(isset($_POST['signup'])){echo $nameErr;}?></span>
				</div>
				<!-- Email field -->
				<div class="md-form mb-4">
				  <input type="text" placeholder="Enter Email" value="<?php if(isset($_POST['signup'])){ echo $email;}?>" name="email" class="form-control validate">
				  <label data-error="wrong" data-success="right" for="orangeForm-email">Email</label>
				  <span class="require">*</span>
				  <span class="error_msg" id="email_err"><?php if(isset($_POST['signup'])){echo $emailErr;}?></span>
				</div>
				<!-- Specilaity field -->
				<div class="md-form mb-4">
				  <input type="text" placeholder="Enter Specilaity" value="<?php if(isset($_POST['signup'])){ echo $exp;}?>" name="speciality" class="form-control validate">
				  <label data-error="wrong" data-success="right" for="orangeForm-spec">Specilaity</label>
				  <span class="require">*</span>
				  <span class="error_msg" id="spec_err"><?php if(isset($_POST['signup'])){echo $specErr;}?></span>
				</div>
			  ...
			  <div class="section_b">
				...
				<div class="md-form mb-5">
				  <i class="lni-phone"></i>
				  <input name="contact" placeholder="Enter Contact Number" value="<?php if(isset($_POST['signup'])){ echo $contact;}?>" type="text" id="orangeForm-contact" class="form-control" onkeydown="getSignUpValue(event)">
				  <label data-error="wrong" data-success="right" for="orangeForm-contact">Contact Number</label>
				  <span class="require">*</span>
				  <span class="error_msg" id="contact_signerror"><?php if(isset($_POST['signup'])){echo $contactSignErr;}?></span>
				</div>				
				<!-- Hospital Assigned field -->
				<div class="md-form mb-4">
				  <select class="cat_login hos_assigned" name="hospitals" id="hos">
					  <option value="select">Select Hospital</option>
					  <option value="pilot">Pilot</option>
					  <option value="passenger">Passenger</option>
					</select>
				  <label for="hospitals" data-error="wrong" data-success="right" for="defaultForm-hosasigned">Select Hospital</label>
				  <span class="require">*</span>
				  <span class="error_msg" id="siggendr_err"><?php if(isset($_POST['signup'])){echo $genderErr;}?></span>
				</div>				
			  </div>	
			</div>
