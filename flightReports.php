				...
				<table id="pilots_report" class="display" style="width:100%">
					...
					<tbody>
						...
						foreach($res as $key => $record){
							echo '<tr>
							<td>'.$record['flight_num'].'</td>
							<td>'.$record['flight_name'].'</td>
							<td>'.$record['flight_date'].'</td>
							<td>'.$record['flight_source'].'</td>
							<td>'.$record['flight_destination'].'</td>
							<td>'.$record['flight_capacity'].'</td>
							</tr>';
						}?>						
					</tbody>
				</table>
