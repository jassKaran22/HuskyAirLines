	...
	<div id="hero-area" class="hero-area-bg">
		...
		<div class="flight_reg" data-keyboard="false">
		  <div class="modal-dialog signupForm" role="document">
			...
			<div class="modal-content">
			  <div class="modal-header text-center">
				<h4 class="modal-title w-100 font-weight-bold">Flight Registration</h4>
			  ...
			  <div class="section_a">
				...
				<div class="md-form mb-5">
				  <i class="lni-plane"></i>
				  <input name="name" placeholder="Enter Flight Name" value="<?php if(isset($_POST['flightSignup'])){ echo $name;}?>" type="text" id="orangeForm-name" class="form-control validate" onkeydown="getSignUpValue(event)">
				  <label data-error="wrong" data-success="right" for="orangeForm-name">Flight Name</label>
				  <span class="require">*</span>
				  <span class="error_msg" id="name_err"><?php if(isset($_POST['flightSignup'])){echo $nameErr;}?></span>
				</div>
				<!-- flight number field -->
				<div class="md-form mb-5">
				  <i class="lni-ticket-alt"></i>
				  <input name="num" placeholder="Enter Flight Number" value="<?php if(isset($_POST['flightSignup'])){ echo $flightNum;}?>" type="text" id="orangeForm-num" class="form-control" onkeydown="getSignUpValue(event)">
				  <label data-error="wrong" data-success="right" for="orangeForm-num">Flight Number</label>
				  <span class="require">*</span>
				  <span class="error_msg" id="flightnum_signerror"><?php if(isset($_POST['flightSignup'])){echo $flightNumErr;}?></span>
				</div>
				
				<!-- flight date field -->
				<div class="md-form mb-4">
				  <i class="lni-calendar"></i>
				  <input type="text" placeholder="Select Flight Date" value="<?php if(isset($_POST['flightSignup'])){ echo $date;}?>" readonly id="date" name="date" placeholder="YYYY/MM/DD" data-provide="datepicker" class="form-control validate">
				  <label data-error="wrong" data-success="right" for="orangeForm-date">Date</label>
				  <span class="require">*</span>
				  <span class="error_msg" id="flightdate_signerror"><?php if(isset($_POST['flightSignup'])){echo $dateErr;}?></span>
				</div>
				</div>
				...
				<div class="md-form mb-4">
				  ...
				  <input name="source" placeholder="Enter Flight Source" type="text" id="orangeForm-source" class="form-control validate" value="<?php if(isset($_POST['flightSignup'])){ echo $source;}?>" onkeydown="getSignUpValue(event)">
				  <label data-error="wrong" data-success="right" for="orangeForm-source">Source</label>
				  <span class="require">*</span>
				  <span class="error_msg" id="flightsour_err"><?php if(isset($_POST['siflightSignupgnup'])){echo $sourceErr;}?></span>
				</div>
				<!-- flight destination field -->
				<div class="md-form mb-4">
					<i class="lni-arrow-down-circle"></i>
					<input name="destination" placeholder="Enter Flight Destination" type="text" id="orangeForm-dest" class="form-control validate" value="<?php if(isset($_POST['flightSignup'])){ echo $destination;}?>" onkeydown="getSignUpValue(event)">
				    <label class="for_destination" data-error="wrong" data-success="right" for="orangeForm-dest">Destination</label>
				  <span class="require">*</span>
				  <span class="error_msg" id="flightdes_err"><?php if(isset($_POST['flightSignup'])){echo $destinationErr;}?></span>
				</div>
				<!-- flight capacity field -->
				<div class="md-form mb-4">
				  <i class="lni-users"></i>
				  <input type="text" placeholder="Enter Number of Passengers Allowed" value="<?php if(isset($_POST['flightSignup'])){ echo $pasengers;}?>" name="capacity" id="orangeForm-capacity" class="form-control validate" onkeydown="getSignUpValue(event)">
				  <label data-error="wrong" data-success="right" for="orangeForm-capacity">Capacity</label>
				  <span class="require">*</span>
				  <span class="error_msg" id="flightcapa_err"><?php if(isset($_POST['flightSignup'])){echo $pasengersErr;}?></span>
				</div>
				</div>
			  ...
			  <div class="modal-footer d-flex justify-content-center">
				...
				<input type="hidden" name="flightSignup">
			  </div>
			</div>
			</form>
		  </div>
