...
<html lang="en">
  ...
  aria-hidden="true" data-backdrop="static" data-keyboard="false">
	...
	<!-- Hospital Registration form starts -->
	<div id="hero-area" class="hero-area-bg">
        <div class="container">
		<div class="hospital_reg" data-keyboard="false">
		  <div class="modal-dialog signupForm" role="document">
			...
			<div class="modal-content">
			  <div class="modal-header text-center">
				<h4 class="modal-title w-100 font-weight-bold">Hospital Registration</h4>
			  ...
			  <div class="section_a">
				...
				<!-- Email field -->
				<div class="md-form mb-5">
				  <input name="email" placeholder="Enter Email" value="<?php if(isset($_POST['signup'])){ echo $email;}?>" type="text" id="orangeForm-email" class="form-control" onkeydown="getSignUpValue(event)">
				  <label data-error="wrong" data-success="right" for="orangeForm-email">Email</label>
				  <span class="require">*</span>
				  <span class="error_msg" id="email_signerror"><?php if(isset($_POST['signup'])){echo $emailSignErr;}?></span>
				</div>
				...
				<!-- Speciality -->
				<div class="md-form mb-4">
				  <input type="text" placeholder="Enter Speciality" value="<?php if(isset($_POST['signup'])){ echo $speciality;}?>" class="form-control validate">
				  <label data-error="wrong" data-success="right" for="orangeForm-spec">Speciality</label>
				</div>
				<!-- contact field -->
				<div class="md-form mb-4">
				  <input type="text" placeholder="Enter Contact Number" value="<?php if(isset($_POST['signup'])){ echo $contact;}?>" name="contact" id="orangeForm-contact" class="form-control validate" maxlength="10" onkeydown="getSignUpValue(event)">
				  <label data-error="wrong" data-success="right" for="orangeForm-pass">Contact Number</label>
				  <span class="require">*</span>
				  <span class="error_msg" id="sigcontac_err"><?php if(isset($_POST['signup'])){echo $contactErr;}?></span>
				</div>
				</div>
				 ...
				 <!-- address field-->
				  <div class="section_c">
					  <div class="md-form mb-8">
						<textarea id="address" placeholder="Enter Address" name="addres" rows="1" cols="149"></textarea>
						<label data-error="wrong" data-success="right" for="orangeForm-adres">Address</label>
						<span class="require">*</span>
						<span class="error_msg" id="sigadres_err"><?php if(isset($_POST['signup'])){echo $adresErr;}?></span>
					  </div>
				  </div>
